...
function Vision() {
    return (
        <div className="container d-lg-flex my-5">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/QKyqT-MM_ek" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
            <div className="custom-width mt-3">
            <p className="fw-bold ms-1 mt-2">
                Our Vision
            </p>
            <h1>Get ready for real <br /> time adventure</h1>
